...
const deleteDocument = async (item,index) => {
  ...
  await deleteDoc(doc(db, "grupa3", `${idDeleteElement}`));
        ...
        <>
         <div className='group-element'>
           ...
           <div className='group-element-images'>
             {item.imgUrl ?<img src={item.imgUrl} alt='img_grupa3' className='img-group' onClick={handleModal}></img> : "" } 
             {item.imgUrl2 ? <img src={item.imgUrl2} alt='img_grupa3' className='img-group' onClick={handleModal}></img> : ""}
