...
function Opłaty() {
  return (
    <div className='oplaty-container'>
        <h2>OPŁATY ZA KORZYSTANIE Z PRZEDSZKOLA</h2>
            ...
            <p>W tytule płatności prosimy wpisywać : OPŁATA ZA PRZEDSZKOLE NR 111 za ... (imię i nazwisko dziecka) ZA MIESIĄC ...</p>

    </div>
  )
}

export default Opłaty